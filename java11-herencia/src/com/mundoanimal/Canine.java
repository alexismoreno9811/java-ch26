...
public abstract class Canine extends Animal {
	...
	public Canine(String name) {
		super(name); // Inicializando el constructor de mi clase superior.
	}
	/**
	 * Estamos sobreescribiento (Overriding) el método de nuestra
	 * clase superior.
	 * La sobreescritura debe tener la misma firma del método
	 ...
	 * en la clase superior. Permite personalizar el comportamiento
	 * heredado.
	 * 
	 * @Override: indica que el método está sobreescribiendo
	 * el comportamiento de un método de la clase heredada.
	 * Su propósito es hacer una verificación en tiempo
	...
	public String eat(String food, double kg) {
		return "El canino " + super.getName() + " come " + kg + " Kg. de " + food; 
	}
