...
public class ExcepcionesConceptos {
	...
	public static void main(String[] args) {
		 ...
		 * de la clase RuntimeExceptions. No se está obligado a procesarlas.
		...
		try {
			...
			e.printStackTrace();
		}*/catch(Exception e){ // esta consume la primer excepción hija que encuentra (se utiliza para generalizar las excepciones)
			e.printStackTrace();
		}
