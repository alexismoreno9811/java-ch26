...
/*
 * Por convención el nombre de los endpoints debe ser sustantivos en plural
 */
...
public class CustomerController {
	...
	public List<Customer> getCustomers() {
		...
		customers.add(new Customer(3, "Angélica", "Vazquez"));
	...
	/*
	 * Request Param
	 * Vincula los parámetros de una solicitud HTTP con los parámteros del método
